...
export function TideChart({ data, currentTime }: { data: TideData[], currentTime: Date }) {
  ...
  return (
    <div className="h-48 w-full mt-4 overflow-x-auto pb-2 scrollbar-thin scrollbar-thumb-slate-700 scrollbar-track-transparent pointer-events-auto">
      <div className="min-w-[500px] h-full flex-1 touch-pan-x">
